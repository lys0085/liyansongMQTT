#
#  Be sure to run `pod spec lint liyansongMQTT.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "李严松"
  # s.authors            = { "李严松" => "lxs0085@sina.com" }
  # s.social_media_url   = "http://twitter.com/李严松"
